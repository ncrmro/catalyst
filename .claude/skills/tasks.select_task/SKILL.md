...
**Goal**: Smart selection of next task or accept user-specified task
...
- **task_id**: Optional: specific task ID to work on. Uses smart selection if not provided.

**Files from Previous Steps** - Read these first:
- `tasks/parsed_tasks.json` (from `parse_tasks`)
...
2. Inform user: "Step 3/8 complete, outputs: tasks/selected_task.json"
3. **Continue workflow**: Use Skill tool to invoke `/tasks.implement_task`

---

**Reference files**: `.deepwork/jobs/tasks/job.yml`, `.deepwork/jobs/tasks/steps/select_task.md`