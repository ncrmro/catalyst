...
UPDATE "project" SET "team_id" = (SELECT "id" FROM "teams" ORDER BY "createdAt" ASC LIMIT 1) WHERE "team_id" IS NULL;--> statement-breakpoint
UPDATE "repo" SET "team_id" = (SELECT "id" FROM "teams" ORDER BY "createdAt" ASC LIMIT 1) WHERE "team_id" IS NULL;--> statement-breakpoint
