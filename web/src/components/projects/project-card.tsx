  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h3 className="text-lg font-semibold text-on-surface truncate">{project.fullName}</h3>
        {project.description && (
          <p className="text-on-surface-variant text-sm mt-1 truncate">{project.description}</p>
        )}
      </div>
