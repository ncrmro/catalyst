...
export function PlatformTaskQueue({
	tasks,
	onRetry,
	onApprove,
	onDismiss,
}: PlatformTaskQueueProps) {
						...
						<div className="flex items-start gap-4">
							...
							<div className="flex-1 min-w-0">
								<div className="flex items-center justify-between mb-1">
									<h4 className="font-semibold text-on-surface truncate pr-4">
										{task.title}
									</h4>
									<span
										className={`px-2 py-0.5 text-xs font-medium rounded-full border uppercase tracking-wide ${getStatusBadge(task.status)}`}
									>
										{task.status}
									</span>
								</div>
