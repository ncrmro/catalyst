...
function loadMockDataFromYaml(): GitHubMockData {
  try {
    ...
    const pullRequests: PullRequest[] = validatedData.pull_requests.map(
      (pr) => ({
        ...pr,
  ...
  "open-source-collective": [
    {
      ...
      clone_url:
        "https://github.com/open-source-collective/community-tools.git",
 ...
 */
export function getMockRepoByFullName(
  fullName: string,
 ...
 */
export function reloadMockData(): GitHubMockData & {
 ...
 */
export function getCurrentMockData(): GitHubMockData & {
  pull_requests: PullRequest[];
} {
  return mockData;
}
