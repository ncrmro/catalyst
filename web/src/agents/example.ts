...
async function main() {
  try {
    ...
    console.log("✅ GitHub MCP tools result:", {
      ...
      toolsCount: gitHubToolsResult.success
        ? Object.keys(gitHubToolsResult.data).length
        : 0,
    ...
    console.log(
      "🔧 Provider:",
      anthropicAgent instanceof PeriodicReportAgent ? "anthropic" : "unknown",
    );
    console.log();
    ...
    const exampleReport = {
      ...
      summary:
        "Current infrastructure is stable with 3 active projects and 2 Kubernetes clusters.",
      projectsAnalysis: {
        totalProjects: 3,
