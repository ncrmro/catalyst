...
type ClusterStatus = "empty" | "provisioning" | "running";
...
export function ClusterProvisioning() {
  const [status, setStatus] = useState<ClusterStatus>("empty");
      ...
      <Card>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-outline/50">
            <div>
              <p className="text-xs text-on-surface-variant">Cluster Name</p>
            ...
            <div>
              ...
              <p className="text-sm text-on-surface">v{k8sVersion}</p>
            </div>
            <div>
              <p className="text-xs text-on-surface-variant">
