...
export default function KubeconfigsPage() {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-4 text-lg text-on-surface-variant">
            Export kubeconfig for use in GitHub Actions, local development, or CI/CD pipelines
          </p>
          <div className="mt-2 p-4 bg-primary-container rounded-lg border border-outline">
            <p className="text-sm text-on-primary-container">
              <strong>✨ GitHub Actions Ready:</strong> This kubeconfig includes the necessary 
              permissions for building images with buildx within the cluster.
            </p>
          </div>
        </div>
        ...
        <div className="bg-surface border border-outline rounded-lg overflow-hidden">
          <div className="p-6 border-b border-outline">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-semibold text-on-surface">Cluster Configuration</h2>
          ...
          <div className="p-6">
            <div className="bg-background border border-outline rounded-lg">
              <div className="p-4 border-b border-outline bg-surface">
                <h3 className="text-sm font-medium text-on-surface">kubeconfig.yaml</h3>
              </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-surface border border-outline rounded-lg p-6">
            <h3 className="text-lg font-semibold text-on-surface mb-4">GitHub Actions Usage</h3>
            <div className="space-y-4">
              <div>
                <h4 className="text-sm font-medium text-on-surface mb-2">1. Add as Repository Secret</h4>
                <p className="text-sm text-on-surface-variant">
                  Copy the kubeconfig content and add it as a secret named <code className="bg-background px-1 rounded">KUBECONFIG</code> in your repository settings.
                </p>
              </div>
              <div>
                <h4 className="text-sm font-medium text-on-surface mb-2">2. Use in Workflow</h4>
  ...
  run: |
    ...
    kubectl get nodes`}
          ...
          {/* Buildx Usage */}
          <div className="bg-surface border border-outline rounded-lg p-6">
            <h3 className="text-lg font-semibold text-on-surface mb-4">Docker Buildx Usage</h3>
            <div className="space-y-4">
              <div>
                <h4 className="text-sm font-medium text-on-surface mb-2">Build in Cluster</h4>
                <p className="text-sm text-on-surface-variant mb-2">
                  Use the kubeconfig to build and push images directly within the cluster:
                </p>
                <div className="bg-background border border-outline rounded p-3">
                  <pre className="text-xs text-on-background font-mono">
...
docker buildx build --builder k8s-builder \\
  -t myapp:latest --push .`}
        ...
        <div className="mt-6 p-4 bg-error-container border border-outline rounded-lg">
          <h3 className="text-sm font-semibold text-on-error-container mb-2">🔒 Security Note</h3>
          <p className="text-sm text-on-error-container">
            This kubeconfig contains authentication tokens. Keep it secure and only share with trusted systems. 
            For production use, consider using shorter-lived tokens or OIDC-based authentication.
          </p>
        </div>
      </div>
    </DashboardLayout>
