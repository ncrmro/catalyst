...
export async function generateLatestPeriodicReport() {
	try {
		...
		const fallbackReport = {
			...
			summary:
				"This is a demonstration report showing the periodic report agent integration. Configure ANTHROPIC_API_KEY environment variable to generate AI-powered reports.",
			projectsAnalysis: {
				totalProjects: 3,
