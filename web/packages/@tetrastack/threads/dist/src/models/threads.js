 ...
 * ```
 */
export function createThreadsModel(db) {
    const base = createModelFactory(db, threads, threads.id, insertThreadSchema);
    return {
        ...base,
        /**
         ...
         */
        async findByScope(projectId, scopeType, scopeId) {
            return base.select([
         ...
         */
        async getOrCreate(projectId, scopeType, scopeId, title) {
